        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-full text-sm">C</span>
            </div>
            <div className="flex gap-3">
              <a 
                href="https://github.com/AnishK05/EcoReviveTX"
                className="inline-flex items-center px-3 py-1.5 bg-gray-600 text-gray-200 rounded-lg hover:bg-gray-500 transition-colors text-xs font-medium"
                target="_blank"
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-full text-sm">LLM Web Search</span>
            </div>
              <div className="flex gap-3">
               <div className="relative group">
                 <a
                   className="inline-flex items-center px-3 py-1.5 bg-gray-600 text-gray-200 rounded-lg hover:bg-gray-500 transition-colors text-xs font-medium cursor-pointer"
                 >
                   <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                   </svg>
                  ...
                  {/* Tooltip */}
                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-4 py-3 bg-gray-900 text-gray-100 text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-full text-sm">Google Maps API</span>
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-full text-sm">React.js</span>
              <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-full text-sm">Spring Boot</span>
              <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded-full text-sm">Machine Learning</span>
            </div>
            <div className="flex gap-3">
              <a 
